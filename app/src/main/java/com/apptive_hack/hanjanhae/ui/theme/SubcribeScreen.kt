...
@Composable
fun SubcribeScreen(navController: NavController){
    Column(
        ...
        SubscriptionCard("1인권", "2개월", "1번", "100,000원", navController)
        SubscriptionCard("2인권", "1개월", "2번", "200,000원", navController)
...
@Composable
fun SubscriptionCard(name: String, month: String, num: String, price:String ,navController: NavController) {
    Card(
        modifier = Modifier
            .padding(horizontal = 32.dp)
            .padding(top = 20.dp)
            .border(1.dp, Color(0xFFE67171), RoundedCornerShape(16.dp))
            .clickable {
                navController.navigate("subscribe2")
            }, // 테두리 추가
...
private fun SuPreview() {
    SubcribeScreen(navController = rememberNavController())
}
